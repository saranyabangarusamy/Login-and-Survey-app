...
class apiHelper {
    ...
    async addQuestion(question) {       
        const res = await fetch(this.apiUrl, {
            ...
            body: JSON.stringify({
                query:`mutation {
                    addQuestion(input : { question: "${question.question}", option1: "${question.option1}", option2: "${question.option2}",option3: "${question.option3}",option4: "${question.option4}", is_right: "${question.is_right}" } )
                  }`
            }),
        });
